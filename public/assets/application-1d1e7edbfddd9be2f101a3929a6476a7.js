...
(function() {
  var HomeControllers, HomeCtrl, ModalControls;

  HomeControllers = angular.module("HomeControllers", ["ngAnimate", "ui.bootstrap"]);

  HomeCtrl = (function() {
    function HomeCtrl(scope, modal, modalControls) {
      this.scope = scope;
      this.modal = modal;
...
(function() {
  ...
  HomeFactories = angular.module("HomeFactories", []);
...
(function() {
  angular.module("HomePageApp", ["HomeRouter", "HomeControllers", "HomeFactories"]);
